...
public class Customer{
	...
	public static Customer createCustomer(String customerType, String name, String address, String iD, String phone, int reward_points) {
		if (customerType.equals("Guest"))
			...
			return SuperVIP.getInstance(name, address, iD, phone, reward_points);
		else
			return null;
	}
}
